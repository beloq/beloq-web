...
export default function Footer() {
  return (
    <footer className="bg-beloq-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              <a
                href="https://www.linkedin.com/company/beloq"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-beloq-yellow transition-colors"
                aria-label="LinkedIn"
              >
              ...
              <a
                href="https://www.instagram.com/beloq.es"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-beloq-yellow transition-colors"
              ...
              <ul className="space-y-2">
                {section.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-sm text-gray-400 hover:text-beloq-yellow transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} BELOQ MOVILIDAD SL — Movilidad urbana
